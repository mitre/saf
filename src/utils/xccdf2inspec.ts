...
export function inspecControlToRubyCode(control: InSpecControl, lineLength?: number, hideUtfEncoding?: boolean): string {
  let result = hideUtfEncoding ? '' : '# encoding: UTF-8\n\n'
