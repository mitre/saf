...
export default class WritePassthrough extends Command {
  ...
  static flags = {
    ...
    passthroughData: Flags.string({char: 'd', description: 'Input passthrough-data (can be any valid JSON); this flag or `passthroughFile` must be provided', exclusive: ['passthroughFile']}),
    passthroughFile: Flags.string({char: 'f', description: 'An input passthrough-data file (can contain any valid JSON); this flag or `passthroughData` must be provided', exclusive: ['passthroughData']}),
  }
