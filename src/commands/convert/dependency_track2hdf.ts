...
export default class DependencyTrack2HDF extends Command {
  static readonly usage = 'convert dependency_track2hdf -i <dt-fpf-json> -o <hdf-scan-results-json>'

  static readonly description = 'Translate a Dependency-Track output file into an HDF results set'

  static readonly examples = ['saf convert dependency_track2hdf -i dt-fpf.json -o output-hdf-name.json']
