...
export default class DBProtectMapper extends Command {
  static usage = 'dbprotect_mapper -x, --xml=XML -o, --output=OUTPUT'

  static description = fs.readFileSync('./help/dbprotect_mapper.md', {encoding: 'utf-8'}).split('Examples:\n')[0]

  static examples = [fs.readFileSync('./help/dbprotect_mapper.md', {encoding: 'utf-8'}).split('Examples:\n')[1]]
