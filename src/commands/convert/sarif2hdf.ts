...
export default class Sarif2HDF extends Command {
  static usage = 'convert sarif2hdf -i, --input=JSON -o, --output=OUTPUT -r, --raw=BOOLEAN'
  ...
  static examples = ['saf convert sarif2hdf -i sarif-results.json -o output-hdf-name.json -r=true']

  static flags = {
    help: Flags.help({char: 'h'}),
    input: Flags.string({char: 'i', required: true}),
    output: Flags.string({char: 'o', required: true}),
    raw: Flags.boolean({char: 'r', required: false}),
  }
