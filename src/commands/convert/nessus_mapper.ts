...
export default class NessusMapper extends Command {
  static usage = 'nessus_mapper -x, --xml=XML -o, --output_prefix=OUTPUT_PREFIX'

  static description = fs.readFileSync('./help/nessus_mapper.md', { encoding: 'utf-8' }).split('Examples:\n')[0]

  static examples = [fs.readFileSync('./help/nessus_mapper.md', { encoding: 'utf-8' }).split('Examples:\n')[1]]
