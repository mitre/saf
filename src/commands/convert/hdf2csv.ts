...
export default class HDF2CSV extends Command {
  static readonly usage =
    'convert hdf2csv -i <hdf-scan-results-json> -o <output-csv> [-h] [-f <csv-fields>] [-t]';

  static readonly description =
    'Translate a Heimdall Data Format JSON file into a Comma Separated Values (CSV) file';
