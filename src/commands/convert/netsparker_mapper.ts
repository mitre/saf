...
export default class NetsparkerMapper extends Command {
  static usage = 'netsparker_mapper -x, --xml=XML -o, --output=OUTPUT'

  static description = fs.readFileSync('./help/netsparker_mapper.md', {encoding: 'utf-8'}).split('Examples:\n')[0]

  static examples = [fs.readFileSync('./help/netsparker_mapper.md', {encoding: 'utf-8'}).split('Examples:\n')[1]]
