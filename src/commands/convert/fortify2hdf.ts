...
export default class Fortify2HDF extends Command {
  static readonly usage =
    'convert fortify2hdf -i <fortify-fvdl> -o <hdf-scan-results-json> [-h] [-w]';

  static readonly description =
    'Translate a Fortify results FVDL file into a Heimdall Data Format JSON file; the FVDL file is an XML that can be extracted from the Fortify FPR project file using standard file compression tools';
