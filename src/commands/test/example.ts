...
export default class ASFFMapper extends Command {
  static usage = 'asff_mapper -i <asff-finding-json> [--securityhub <standard-1-json> ... <standard-n-json>] -o <hdf-scan-results-json>'

  static description = fs.readFileSync('./help/asff_mapper.md', { encoding: 'utf-8' }).split('Examples:\n')[0]

  static examples = [fs.readFileSync('./help/asff_mapper.md', { encoding: 'utf-8' }).split('Examples:\n')[1]]
