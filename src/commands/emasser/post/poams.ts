...
export default class EmasserPostPoams extends Command {
  ...
  static description = "Add a Plan of Action and Milestones (POA&M) into a systems. Please references emasser Features (emasserFeatures.md) for additional information."
  ...
  static flags = {
    help: Flags.help({char: 'h', description: 'Post (add) a Plan of Action and Milestones (POA&M) item(s) in a system'}),
