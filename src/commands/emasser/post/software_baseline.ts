...
export default class EmasserSoftwareBaseline extends Command {
  ...
  static readonly examples = [
    '<%= config.bin %> <%= command.id %> [-s,--systemId] [-a,--assetName] [-f,--dataFile]',
  ...
  async run(): Promise<void> {
    ...
    const hwBaseline = new SoftwareBaselineApi(apiCxn.configuration, apiCxn.basePath, apiCxn.axiosInstances)
    ...
    // Call the endpoint
    hwBaseline.addSwBaselineAssets(flags.systemId, requestBodyArray).then((response: SwBaselineResponsePostPut) => {
