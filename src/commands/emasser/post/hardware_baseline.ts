...
import {HwBaselineResponsePostPut} from '@mitre/emass_client/dist/api'
...
export default class EmasserHardwareBaseline extends Command {
  ...
  async run(): Promise<void> {
    ...
    // Call the endpoint
    hwBaseline.addHwBaselineAssets(flags.systemId, requestBodyArray).then((response: HwBaselineResponsePostPut) => {
