...
successful/unsuccessful attempts to use the \"lsetxattr\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S lsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

-a always,exit -F arch=b64 -S 
lsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

If both the \"b32\" and \"b64\" audit 
rules are not defined for the \"lsetxattr\" syscall, this is a finding." 
...
-a 
always,exit -F arch=b32 -S lsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
