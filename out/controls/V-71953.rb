...
\"AutomaticLoginEnable\" in the \"/etc/gdm/custom.conf\" file with the following 
command:
...
If 
the value of \"AutomaticLoginEnable\" is not set to \"false\", this is a finding." 
...
\"AutomaticLoginEnable\" parameter in the [daemon] section of the 
