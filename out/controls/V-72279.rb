...
the use of two-factor authentication."
  desc  "rationale", ""
  desc "check", "Verify there are no \"shosts.equiv\" files on the 
system.
...
If any \"shosts.equiv\" 
files are found on the system, this is a finding." 
  desc "fix", "Remove any found \"shosts.equiv\" files from the 
system.
