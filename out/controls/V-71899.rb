...
not have a Graphical User Interface installed, this requirement is Not 
Applicable.

Check for the session lock settings 
...
Add 
the setting to enable screensaver locking after 15 minutes of inactivity:
