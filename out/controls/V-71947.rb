...
requires users to supply a password for privilege 
escalation.
...
found with a \"NOPASSWD\" tag, this is a finding." 
  desc "fix", "Configure the operating system to require users to supply a password for 
privilege escalation.

Check the configuration 
of the \"/etc/sudoers\" file with the following command:
# 
visudo
