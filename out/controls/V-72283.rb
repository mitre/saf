...
forwarding is enabled and the system is functioning as a router."
  desc  "rationale", ""
  desc "check", "Verify the system does not accept IPv4 source-routed 
packets.

# grep 
net.ipv4.conf.all.accept_source_route /etc/sysctl.conf /etc/sysctl.d/*

net.ipv4.conf.all.accept_source_route 
= 0

If \" 
net.ipv4.conf.all.accept_source_route \" is not configured in the /etc/sysctl.conf file 
