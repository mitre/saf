...
successful/unsuccessful attempts to use the \"lremovexattr\" syscall 
occur.
...
# grep -iw lremovexattr 
/etc/audit/audit.rules

-a always,exit -F 
arch=b32 -S lremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

-a always,exit -F arch=b64 -S 
lremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

If both the \"b32\" and \"b64\" audit 
rules are not defined for the \"lremovexattr\" syscall, this is a finding." 
...
-a 
always,exit -F arch=b32 -S lremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
...
The audit daemon must be restarted for 
