...
successful/unsuccessful attempts to use the \"sudo\" command 
occur.
...
# grep -iw 
/usr/bin/sudo /etc/audit/audit.rules

-a 
always,exit -F path=/usr/bin/sudo -F auid>=1000 -F auid!=4294967295 -k 
