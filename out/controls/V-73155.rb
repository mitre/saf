...
control "V-73155" do
  ...
  "
  desc  "rationale", ""
  desc "check", "Verify the operating system prevents a user from overriding a screensaver 
...
lock after a 15-minute period of inactivity for graphical user 
interfaces.
...
Add the 
setting to lock the screensaver lock delay:
