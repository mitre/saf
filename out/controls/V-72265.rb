...
vulnerabilities in the unprivileged section."
  desc  "rationale", ""
  desc "check", "Verify the SSH daemon performs privilege 
separation.

Check that the SSH daemon performs 
privilege separation with the following 
command:
...
keyword is set to \"no\", is missing, or the returned line is commented out, this is a finding." 
...
The SSH service must be restarted for 
