...
Check for the 
value of \"PASS_MIN_DAYS\" in \"/etc/login.defs\" with the following command: 
...
If the \"PASS_MIN_DAYS\" parameter value is 
not \"1\" or greater, or is commented out, this is a finding." 
  desc "fix", "Configure the operating system to enforce 24 hours/1 day as the minimum password 
lifetime.
