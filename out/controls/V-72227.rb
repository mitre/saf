...
implements cryptography to protect the integrity of remote LDAP authentication 
sessions.
...
Ensure that LDAP is configured 
to use TLS by using the following command:

# grep 
-i \"start_tls\" /etc/sssd/sssd.conf
ldap_id_use_start_tls = 
true

If the \"ldap_id_use_start_tls\" option 
...
Add 
or modify the following line in \"/etc/sssd/sssd.conf\":
