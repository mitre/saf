...
-a always,exit -F 
path=/usr/bin/umount -F auid>=1000 -F auid!=4294967295 -k privileged-mount 


If the command does not return any output, this is 
a finding." 
...
-a 
always,exit -F path=/usr/bin/umount -F auid>=1000 -F auid!=4294967295 -k 
privileged-mount
