...
have to be employed, and vice versa.
  ...
  "
  desc  "rationale", ""
  desc "check", "Check to see if sshd is installed with the following 
command:

# yum list installed 
\\*ssh\\*
libssh2.x86_64 1.4.3-8.el7 
@anaconda/7.1
...
If the \"SSH server\" package is 
not installed, this is a finding." 
  desc "fix", "Install SSH packages onto the host with the following 
commands:
