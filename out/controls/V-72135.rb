...
successful/unsuccessful attempts to use the \"semanage\" command 
occur.
...
# grep -i /usr/sbin/semanage 
/etc/audit/audit.rules

-a always,exit -F 
path=/usr/sbin/semanage -F auid>=1000 -F auid!=4294967295 -k 
...
-a 
always,exit -F path=/usr/sbin/semanage -F auid>=1000 -F auid!=4294967295 -k 
privileged-priv_change
