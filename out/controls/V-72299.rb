...
methods must be used in place of this service."
  desc  "rationale", ""
  desc "check", "Verify an FTP server has not been installed on the 
system.

Check to see if an FTP server has been 
installed with the following commands:

# yum 
list installed vsftpd
...
remove it from the system with the following 
command:
