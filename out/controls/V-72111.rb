...
successful/unsuccessful attempts to use the \"setxattr\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S setxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
...
rules are not defined for the \"setxattr\" syscall, this is a finding." 
...
-a 
always,exit -F arch=b32 -S setxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
