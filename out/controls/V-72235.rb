...
not have to be employed, and vice versa.
  ...
  "
  desc  "rationale", ""
  desc "check", "Verify SSH is loaded and active with the following 
command:
...
enabled)
Active: active (running) since Tue 2015-11-17 15:17:22 EST; 
4 weeks 0 days ago
Main PID: 1348 (sshd)
CGroup: 
...
If \"sshd\" does not show a status of 
\"active\" and \"running\", this is a finding." 
