...
successful/unsuccessful attempts to use the \"chage\" command 
occur.
...
# grep -i /usr/bin/chage 
/etc/audit/audit.rules

-a always,exit -F 
path=/usr/bin/chage -F auid>=1000 -F auid!=4294967295 -k 
privileged-passwd
...
-a 
always,exit -F path=/usr/bin/chage -F auid>=1000 -F auid!=4294967295 -k 
privileged-passwd
