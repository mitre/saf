...
\"pwquality\" with the following command:

# cat 
/etc/pam.d/system-auth | grep 
pam_pwquality
...
If the command does 
not return an uncommented line containing the value \"pam_pwquality.so\", this is a 
finding.

If the value of \"retry\" is set to \"0\" 
or greater than \"3\", this is a finding." 
  desc "fix", "Configure the operating system to use \"pwquality\" to enforce password 
complexity rules.

Add the following line to 
\"/etc/pam.d/system-auth\" (or modify the line to have the required 
value):

password required pam_pwquality.so 
retry=3

Note: The value of \"retry\" should be 
between \"1\" and \"3\"." 
  impact 0.5
  tag severity: "medium "
