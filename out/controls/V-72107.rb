...
successful/unsuccessful attempts to use the \"fchmod\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S fchmod -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

-a always,exit -F arch=b64 -S fchmod -F 
auid>=1000 -F auid!=4294967295 -k perm_mod

If 
both the \"b32\" and \"b64\" audit rules are not defined for the \"fchmod\" syscall, this is a 
finding." 
...
-a 
always,exit -F arch=b32 -S fchmod -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
