...
Determine 
the \"id_provider\" that the LDAP is currently 
using:
...
Check the path to the X.509 
certificate for peer authentication with the following 
command:
...
Verify the 
\"ldap_tls_cacert\" option points to a file that contains the trusted CA 
certificate.
