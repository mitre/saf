...
successful/unsuccessful attempts to use the \"rmdir\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S rmdir -F auid>=1000 -F auid!=4294967295 -k 
delete

-a always,exit -F arch=b64 -S rmdir -F 
auid>=1000 -F auid!=4294967295 -k delete

If 
both the \"b32\" and \"b64\" audit rules are not defined for the \"rmdir\" syscall, this is a 
finding." 
...
-a 
always,exit -F arch=b32 -S rmdir -F auid>=1000 -F auid!=4294967295 -k 
delete
