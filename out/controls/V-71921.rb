...
plain text."
  desc  "rationale", ""
  desc "check", "Verify the system's shadow file is configured to store only encrypted 
...
If the \"/etc/login.defs\" 
configuration file does not exist or allows for password hashes other than SHA512 to be used, 
this is a finding." 
