...
successful/unsuccessful attempts to use the \"creat\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S creat F exit=-EPERM -F auid>=1000 -F auid!=4294967295 -k 
access
...
rules are not defined for the \"creat\" syscall, this is a 
finding.
...
-a 
always,exit -F arch=b32 -S creat -F exit=-EPERM -F auid>=1000 -F auid!=4294967295 -k 
access
