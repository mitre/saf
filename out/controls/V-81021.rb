...
correct system.
  ...
  "
  desc  "rationale", ""
  desc "check", "Verify the audisp daemon is configured to label all off-loaded audit 
logs:
...
If the \"name_format\" option is not 
\"hostname\", \"fqd\", or \"numeric\", or the line is commented out, this is a finding." 
  desc "fix", "Edit the /etc/audisp/audispd.conf file and add or update the \"name_format\" 
option:
