...
successful/unsuccessful attempts to use the \"fremovexattr\" syscall 
occur.
...
# grep -iw fremovexattr 
/etc/audit/audit.rules

-a always,exit -F 
arch=b32 -S fremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

-a always,exit -F arch=b64 -S 
fremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

If both the \"b32\" and \"b64\" audit 
rules are not defined for the \"fremovexattr\" syscall, this is a finding." 
...
-a 
always,exit -F arch=b32 -S fremovexattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
