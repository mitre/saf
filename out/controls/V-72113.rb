...
successful/unsuccessful attempts to use the \"fsetxattr\" syscall 
occur.
...
-a always,exit -F 
arch=b32 -S fsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

-a always,exit -F arch=b64 -S 
fsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod

If both the \"b32\" and \"b64\" audit 
rules are not defined for the \"fsetxattr\" syscall, this is a finding." 
...
-a 
always,exit -F arch=b32 -S fsetxattr -F auid>=1000 -F auid!=4294967295 -k 
perm_mod
