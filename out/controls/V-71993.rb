...
Check that the 
ctrl-alt-del.target is masked and not active with the following 
command:
...
If the ctrl-alt-del.target is not 
masked, this is a finding.

If the 
ctrl-alt-del.target is active, this is a finding." 
