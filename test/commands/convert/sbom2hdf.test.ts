...
describe('Test sbom', () => {
  ...
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/dropwizard-vex.json'), '-o', `${tmpobj.name}/sbom.json`])
    .it('hdf-converter output test - dropwizard vex', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-dropwizard-vex-hdf.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/dropwizard-vulns.json'), '-o', `${tmpobj.name}/sbom.json`])
    .it('hdf-converter output test - dropwizard w/ vulns', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-dropwizard-vulns-hdf.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
  test
    .stdout()
  ...
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/vex.json'), '-o', `${tmpobj.name}/sbom.json`])
    .it('hdf-converter output test - vex', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-vex-hdf.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
})
...
describe('Test sbom using withraw flag', () => {
  ...
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/dropwizard-vex.json'), '-o', `${tmpobj.name}/sbom.json`, '-w'])
    .it('hdf-converter withraw output test - dropwizard vex', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-dropwizard-vex-hdf-withraw.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/dropwizard-vulns.json'), '-o', `${tmpobj.name}/sbom.json`, '-w'])
    .it('hdf-converter withraw output test - dropwizard w/ vulns', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-dropwizard-vulns-hdf-withraw.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
  test
    .stdout()
  ...
  test
    .stdout()
    .command(['convert sbom2hdf', '-i', path.resolve('./test/sample_data/sbom/sample_input_report/vex.json'), '-o', `${tmpobj.name}/sbom.json`, '-w'])
    .it('hdf-converter withraw output test - vex', () => {
      const converted = JSON.parse(fs.readFileSync(`${tmpobj.name}/sbom.json`, 'utf8'))
      const sample = JSON.parse(fs.readFileSync(path.resolve('./test/sample_data/sbom/sbom-vex-hdf-withraw.json'), 'utf8'))
      expect(omitHDFChangingFields(converted)).to.eql(omitHDFChangingFields(sample))
    })
})
