...
describe.sequential('Test ckl2hdf', () => {
  describe('RHEL8 example', () => {
  ...
  describe('RHEL8 example with raw', () => {
    const tmpobj = tmp.dirSync({ unsafeCleanup: true });
  ...
  describe('Three Stig Checklist example', () => {
    const tmpobj = tmp.dirSync({ unsafeCleanup: true });
  ...
  describe('Small Checklist Overrides examples', () => {
    const tmpobj = tmp.dirSync({ unsafeCleanup: true });
  ...
  describe('Invalid checklist metadata example', () => {
    const tmpobj = tmp.dirSync({ unsafeCleanup: true });
