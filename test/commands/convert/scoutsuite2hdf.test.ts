...
describe('Test scoutsuite using withraw flag', () => {
  ...
  test
    .stdout()
    .command(['convert scoutsuite2hdf', '-i', path.resolve('./test/sample_data/scoutsuite/sample_input_report/scoutsuite_sample.js'), '-o', `${tmpobj.name}/scoutsuitetest.json`, '-w'])
