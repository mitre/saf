...
describe('Test xccdf_results', () => {
  ...
  test
  .stdout()
  .command(['normalize:xccdf_results', '-i', path.resolve('./test/sample_jsons/xccdf_results/sample_input_report/xccdf-results.xml'), '-o', `${tmpobj.name}/xccdfresultstest.json`])
