...
describe('Test burpsuite', () => {
  ...
  test
  .stdout()
  .command(['normalize:burpsuite', '-i', path.resolve('./test/sample_jsons/burpsuite/sample_input_report/zero.webappsecurity.com.min'), '-o', `${tmpobj.name}/burpsuitetest.json`])
